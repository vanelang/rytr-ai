  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-white/10 bg-black/95 backdrop-blur supports-[backdrop-filter]:bg-black/60">
      <div className="flex h-16">
        {/* Left side - matches main content width */}
        ...
        {/* Right side - matches sidebar width */}
        <div className="hidden lg:block w-80 border-l border-white/10 px-6 flex items-center">
          {/* Space for potential sidebar header content */}
        </div>
      </div>
    </header>
  );
